...
#define CCMU_AUDIO_CODEC_BGR_REG			(SUNXI_CCM_BASE + 0xA6C)

/* cfg list */
#define CCMU_CPUX_AXI_CFG_REG              (SUNXI_CCM_BASE + 0x500)
#define CCMU_AHB0_CFG_REG                  (SUNXI_CCM_BASE + 0x510)
#define CCMU_APB0_CFG_GREG                 (SUNXI_CCM_BASE + 0x520)
#define CCMU_APB1_CFG_GREG                 (SUNXI_CCM_BASE + 0x524)
...
#define CCMU_DISP_BGR_REG                (SUNXI_CCM_BASE + 0xDD8)
#define SUNXI_TVFE_TOP_BASE                    0x05700000
#define SVP_CLK_GATE_REG                (SUNXI_TVFE_TOP_BASE + 0x40)
#define SVP_RST_GATE_REG                (SUNXI_TVFE_TOP_BASE + 0x44)
#define PNL_CLK_GATE_REG                (SUNXI_TVFE_TOP_BASE + 0x80)
#define PNL_RST_GATE_REG                (SUNXI_TVFE_TOP_BASE + 0x88)
